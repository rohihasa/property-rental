...
public interface ApplicationService {
    ...
    ResponseEntity<?> updateApplicationStatus(String applicationId, String status);
    ...
    ResponseEntity<Transaction> createTransaction(String applicationId, String paymentMethod, String paymentStatus, String paymentAmount);
